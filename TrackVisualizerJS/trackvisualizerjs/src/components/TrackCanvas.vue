<template>
    <div class="d-flex">
        ...
        <div class="ms-3" style="flex: 1">
            ...
            <button @click="calculatePython" class="btn btn-info my-2">Calculate Python</button>
            <hr />
...
`;
    ...
    async calculatePython() {
        ...
        console.log(data);
        console.log((this.output + data).split("\n"));
        this.output += data;
    }
...
function mul(p: readonly [number, number], p2: number) {
    return [p[0] * p2, p[1] * p2] as const;
}
